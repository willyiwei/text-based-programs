...
CLI/Text based program to show weather-app for a given location.
...
def build_weather_query(city_input, imperial=False):
    ...
    # encodes the string so that you can make a valid HTTP request to the API
...
def get_weather_data(query_url):
    ...
    try:
        ...
        sys.exit("Cannot read the server response.")


def _select_weather_display_params(weather_id) -> tuple:
